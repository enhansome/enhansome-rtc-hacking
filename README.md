...
* [Metasploit auxiliary modules](https://github.com/rapid7/metasploit-framework/tree/master/modules/auxiliary/voip) ⭐ 38,795 | 🐛 610 | 🌐 Ruby | 📅 2026-08-12
...
* [stunner](https://github.com/firefart/stunner) ⭐ 858 | 🐛 4 | 🌐 Go | 📅 2026-08-12 -  a tool to test and exploit STUN, TURN and TURN over TCP servers.
...
* [sipexer](https://github.com/miconda/sipexer) ⭐ 415 | 🐛 1 | 🌐 Go | 📅 2026-07-17 - modern and flexible SIP command line client for testing SIP servers and devices, with custom requests, registration floods, stateful dialogues and lightweight fuzzing.
* [SigPloit](https://github.com/SigPloiter/SigPloit) ⭐ 383 | 🐛 60 | 🌐 Java | 📅 2019-12-17 - Tool which covers all used SS7, GTP (3G), Diameter (4G) or even SIP protocols for IMS and VoLTE infrastructures.
...
* [Awesome Telco](https://github.com/ravens/awesome-telco) ⭐ 987 | 🐛 0 | 🌐 Python | 📅 2026-08-08
